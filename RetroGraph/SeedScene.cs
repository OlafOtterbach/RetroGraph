...
namespace RetroGraph
{
    public static class SeedScene
    {
        public static Scene CreateAndPopulateScene()
        {
            ...
            var oval = Oval.Create(12, 1, 4, 2, false, false, false, true, 10, 2, Matrix44D.CreateTranslation(new Vector3D(12,0,0)) * Matrix44D.CreateRotation(new Vector3D(0,0,1), 180.0.DegToRad()));
            oval.Frame = Matrix44D.CreateTranslation(new Vector3D(0, 0, 0));
            scene.Bodies.Add(oval);
